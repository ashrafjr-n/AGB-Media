...
- **Founder** paints an opaque `--color-black` on `.founder` itself, so content past the first screen lands on that. Its ground can be a screen tall because the section has a floor underneath it. **Keep it at 100vh.**
